'use strict';
/* App Module */
var kuralApp = angular.module('kuralApp', ['ngRoute', 'ngSanitize', 'ngTouch', 'pascalprecht.translate',  'kuralControllers', 'underscore', 'cacheService']);
...
kuralApp.config(function(snapRemoteProvider) {
